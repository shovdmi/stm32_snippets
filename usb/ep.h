...
#define EP_WRITE_BITS(EP_VALUE, VALUE_, VALUE_MASK_)   write_bits(VALUE_, EP_VALUE, VALUE_MASK_, USB_W_MASK, USB_W0_MASK, USB_T_MASK)
#define EP_SET_BITS(EP_VALUE, VALUE_, VALUE_MASK_)       set_bits(VALUE_, EP_VALUE, VALUE_MASK_, USB_W_MASK, USB_W0_MASK, USB_T_MASK)
#define EP_CLEAR_BITS(EP_VALUE, VALUE_, VALUE_MASK_)   clear_bits(VALUE_, EP_VALUE, VALUE_MASK_, USB_W_MASK, USB_W0_MASK, USB_T_MASK)
#define EP_TOGGLE_BITS(EP_VALUE, VALUE_, VALUE_MASK_) toggle_bits(VALUE_, EP_VALUE, VALUE_MASK_, USB_W_MASK, USB_W0_MASK, USB_T_MASK)
